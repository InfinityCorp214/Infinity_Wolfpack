...
for move = 1, 10 do
    ...
    Font.ftPrint(fontSmall, 408+movec, plusYValue+380, 0, 512, 64, xetLang[15], baseColorFull)
    ----------------------------------------------------------------------------
...
while XEBKeepInContextMenu do
    ...
    Font.ftPrint(fontSmall, 408, plusYValue+380, 0, 512, 64, xetLang[15], baseColorFull)
    ----------------------------------------------------------------------------
