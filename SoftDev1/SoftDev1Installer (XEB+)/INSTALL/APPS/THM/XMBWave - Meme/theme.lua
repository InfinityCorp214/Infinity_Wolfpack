...
baseColorFaded = Color.new(255, 255, 255, 14)
...
themeAssetUserTable[7]="funnybkg.png";
...
function thmDrawBKG()
	...
	Graphics.drawImageExtended(themeAssetUser[7], 352, plusYValue+240, 0, 0, 720, 480, 720, 484, 0, 255)
	Graphics.drawRect(352, 240, 704, 480, Color.new(0,0,0,72))
